...
// Dentro de QuestionManager.kt, perto das outras listas (beginnerQuestions, relampagoQuestionList)
    ...
    private val perfeicaoBaseQuestionsPt: List<Question> = listOf(
        ...
        Question(
            ...
            correctAnswerIndex = 2,
            // CORREÇÃO: 5x-10=15 -> 5x=25 -> x=5. O índice correto é 2.
        ),
        ...
        Question(
            ...
            correctAnswerIndex = 1,
            // CORREÇÃO: 2x=30, x=15. Metade de 15 é 7.5. O índice correto é 1.
        ),
        // Fração (8/20 = 2/5)
        Question(
        ...
        Question(
            ...
            correctAnswerIndex = 3,
            // CORREÇÃO: O resultado é 14. O índice correto é 3.
        ),
        ...
        Question(
            ...
            correctAnswerIndex = 2,
            // CORREÇÃO: O resultado é R$100. O índice correto é 2.
        ),
        ...
        Question(
            ...
            correctAnswerIndex = 2,
            // CORREÇÃO: O resultado é 12. O índice correto é 2.
        ),
        ...
        Question(
            ...
            options = listOf("3", "4", "5", "6"),
            correctAnswerIndex = 0,
            // CORREÇÃO: O resultado é 3. O índice correto é 0.
        ),
        // Progressão (+3)
        Question(
            ...
            correctAnswerIndex = 2,
            // CORREÇÃO: O resultado é 23. O índice correto é 2.
        ),
        ...
        Question(
            ...
            correctAnswerIndex = 2,
            // CORREÇÃO: O resultado é 6. O índice correto é 2. (Ou 4, se o resto for o que sobrou fora da cesta). Se a pergunta implica que 'restam na cesta' é 6, o índice é 2. Se implica que 'restam' é 4, o índice é 1. Baseado na sua resposta original (3), assumiu a opção 'Ainda 6' no índice 3.
        ),
...
// Dentro de QuestionManager.kt, adicione esta lista (com o nome 'enigmaQuestionList' se for usar o método corrigido)
    ...
    private val enigmaBaseQuestionsPt: List<Question> = listOf(
        ...
        Question(
            ...
            correctAnswerIndex = 1,
            // Resposta: Seu filho (Explicação: Se o pai daquele homem é filho do meu pai, e ele não tem irmãos, ele é o único filho do pai dele. Logo, o pai daquele homem é ELE. Se o homem retratado tem ELE como pai, o retratado é SEU FILHO.)
        ),
        ...
        Question(
            ...
            correctAnswerIndex = 1,
            // Resposta: 3 (É o problema clássico das 12 bolas e 3 pesagens)
        ),
        ...
        Question(
            ...
            correctAnswerIndex = 2,
            // Resposta: 21 (Sequência de Fibonacci: cada número é a soma dos dois anteriores)
        ),
        ...
        Question(
            ...
            correctAnswerIndex = 0,
            // Resposta: 5 minutos (Todos fervem simultaneamente)
        ),
        ...
        Question(
            ...
            correctAnswerIndex = 1,
            // Resposta: 8 (Fórmula reversa: 10*3 = 30; 30-6 = 24; 24/3 = 8)
        ),
        ...
        Question(
            ...
            correctAnswerIndex = 1,
            // Resposta: 3 (Pior caso: tira 1ª azul, tira 2ª preta. A 3ª OBRIGATORIAMENTE formará um par com a azul ou a preta).
        ),
        ...
        Question(
            ...
            correctAnswerIndex = 2,
            // Resposta: 28 (Fórmula n(n-1)/2: 8*7/2 = 28)
        ),
        ...
        Question(
            ...
            correctAnswerIndex = 1,
            // Resposta: Quinta-feira (O ontem de Sábado é Sexta-feira. Se 'Amanhã será Sexta-feira', então Hoje é Quinta-feira.)
        ),
